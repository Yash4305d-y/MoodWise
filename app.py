    ...
    if predict_clicked:
        if not user_text.strip():
            ...
            with st.spinner("Analyzing your text..."):
                ...
                predicted_emotion = id_to_label[pred_id]
            ...
            bg_color = emotion_colors.get(emotion_key, "#6B7280")
            ...
            with result_col:
                ...
                st.markdown(f"""
<div class="emotion-name">{icon} {predicted_emotion.title()}</div>
...
""", unsafe_allow_html=True)
                ...
                st.markdown(f"""
<div class="emotion-description">{description}</div>
""", unsafe_allow_html=True)
