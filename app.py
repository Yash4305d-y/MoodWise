...
<style>
    ...
    div[data-testid="stTextArea"] textarea:focus {
        ...
        box-shadow:
            0 0 0 2px rgba(245, 158, 11, 0.14) !important;
    }
    ...
    div.stButton > button[kind="primary"] {
        ...
        box-shadow:
            0 6px 20px rgba(234, 88, 12, 0.18);
    ...
    div.stButton > button[kind="primary"]:hover {
        ...
        box-shadow:
            0 8px 25px rgba(234, 88, 12, 0.28);
    }
...
def load_artifacts():
    ...
    id_to_label = joblib.load(
        os.path.join(model_dir, "id_to_label.pkl")
    )
...
try:
    ...
    emotion_descriptions = {
        ...
        "sadness":
            "The text expresses feelings of sadness, loneliness, disappointment, or loss.",

        "anger":
            "The text expresses frustration, irritation, annoyance, or anger.",

        "love":
            "The text expresses affection, care, attraction, or strong emotional connection.",

        "surprise":
            "The text expresses astonishment, unexpectedness, or something remarkable.",

        "fear":
            "The text expresses worry, anxiety, nervousness, or fear.",

        "joy":
            "The text expresses happiness, excitement, satisfaction, or positive feelings."
    }
    ...
    <div class="hero">
        ...
        <div class="hero-subtitle">
            Understand the emotion hiding behind your words.
        </div>
    ...
    examples = {
        ...
        "😊 Joy":
            "I am so happy and delighted with these amazing results!",

        "😠 Anger":
            "I am feeling so frustrated and annoyed with the delay!",

        "😢 Sadness":
            "I feel so lonely and hopeless today.",

        "😲 Surprise":
            "I was completely astonished by the unexpected news!"
    }
    ...
    user_text = st.text_area(
        ...
        placeholder=
            "e.g. I'm super excited about launching this new NLP application!",
